...
Dans cette fonction nous pouvons apercevoir des variables cx et cy. Ces variables désigne le centre de chaque objet. Ainsi nous avons la position de l'objet détecté dans l'image ce qui est très pratique pour effectuer un suivi d'objet.  
